...
export const LEVELS: readonly LevelDef[] = [
  ...
  L('count', 'seq-20', 'Číselná řada', '4, 5, _', 'Které číslo chybí? (do 20, i pozpátku)', g.sequence(20, [1])),
  ...
  L('count', 'seq-100', 'Po dvou, pěti, deseti', '10, 20, _', 'Číselná řada po 2, 5 a 10 do 100', g.sequence(100, [2, 5, 10])),
  ...
  L('add', 'add-make10', 'Kamarádi desítky', '7 + _ = 10', 'Doplň do deseti', g.makeTen()),
  ...
  L('add', 'add-miss20', 'Chybějící číslo', '_ + 6 = 14', 'Doplň chybějící sčítanec (do 20)', g.addMissing(20)),
  ...
  L('sub', 'sub-miss20', 'Chybějící číslo', '12 − _ = 5', 'Doplň chybějící číslo (do 20)', g.subMissing(20)),
  ...
  L('mul', 'mul-miss', 'Chybějící činitel', '4 · _ = 28', 'Doplň chybějící číslo', g.mulMissing()),
  ...
  L('div', 'div-miss', 'Chybějící číslo', '_ : 4 = 6', 'Doplň dělence nebo dělitele', g.divMissing()),
